...
def Begin (df,LabelOfTarget):
    ...
    #pd.DataFrame(gridSearchN.cv_results_).sort_values(by='rank_test_score').to_csv('Results_GridSearch_Numerical_SVM_Over_'+LabelOfTarget+'.csv')
    pd.DataFrame(gridSearchT.cv_results_).sort_values(by='rank_test_score').to_csv('Results_GridSearch_Text_SVM_Over_'+LabelOfTarget+'.csv')
    #pd.DataFrame(gridSearchTN.cv_results_).sort_values(by='rank_test_score').to_csv('Results_GridSearch_BothFeatures_SVM_Over_'+LabelOfTarget+'.csv')
    #joblib.dump(gridSearchN.best_estimator_,'SVMN_Over_'+LabelOfTarget+'.pkl')
    joblib.dump(gridSearchT.best_estimator_,'SVMT_Over_'+LabelOfTarget+'.pkl')
    #joblib.dump(gridSearchTN.best_estimator_,'SVMTN_Over_'+LabelOfTarget+'.pkl')
    #clf=joblib.load('SVMN_Over_'+LabelOfTarget+'.pkl')
    #clf=joblib.load('SVMT_Over_'+LabelOfTarget+'.pkl')
    #clf=joblib.load('SVMTN_Over_'+LabelOfTarget+'.pkl')
