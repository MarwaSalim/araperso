...
def Begin (df,LabelOfTarget):
    ...
    #   'Results_GridSearch_Numerical_DT_Over_' + LabelOfTarget + '.csv')
    #joblib.dump(gridSearchN.best_estimator_, './DTN_Over_'+LabelOfTarget+'.pkl')
    pd.DataFrame(gridSearchT.cv_results_).sort_values(by='rank_test_score').to_csv(
         'Results_GridSearch_Text_DT_Over_' + LabelOfTarget + '.csv')
    joblib.dump(gridSearchT.best_estimator_, './DTT_Over_'+LabelOfTarget+'.pkl')
    #pd.DataFrame(gridSearchTN.cv_results_).sort_values(by='rank_test_score').to_csv('Results_GridSearch_BothFeatures_DT_Over_'+LabelOfTarget+'.csv')
    #joblib.dump(gridSearchTN.best_estimator_,'./DTTN_Over_'+LabelOfTarget+'.pkl')
    ...
    #     print f
    # clf=joblib.load('./DTN_Over_'+LabelOfTarget+'.pkl')
    # clf=joblib.load('./DTT_Over_'+LabelOfTarget+'.pkl')
    # clf=joblib.load('./DTTN_Over_'+LabelOfTarget+'.pkl')
